...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        criarAreaExemplo("SP-021-KM-15", "SP-021 - Rodoanel Mario Covas", 15.0, 17.0, "Pista Leste", "Misto");

        System.out.println("Areas de monitoramento criadas com sucesso.");

        System.out.println("Simulando coleta inicial de dados dos sensores...");
        medicaoService.simularColetaTodasAreas();

        System.out.println("Inicializacao concluida. Sistema pronto para uso.");
    }
